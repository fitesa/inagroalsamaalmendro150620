...
var style_EvolucinIndicedeVegetacin_3 = function(feature, resolution){
    ...
    if (value >= -0.483506 && value <= -0.377364) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.377364 && value <= -0.271223) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.271223 && value <= -0.165081) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.165081 && value <= -0.058939) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.058939 && value <= 0.047202) {
            style = [ new ol.style.Style({
