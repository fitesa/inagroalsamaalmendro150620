...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.113316 && value <= -0.062075) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.062075 && value <= -0.010834) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.010834 && value <= 0.040407) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.040407 && value <= 0.091648) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.091648 && value <= 0.142889) {
            style = [ new ol.style.Style({
