...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.189483 && value <= 0.268621) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.268621 && value <= 0.347759) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.347759 && value <= 0.426897) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.426897 && value <= 0.506035) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.506035 && value <= 0.585173) {
            style = [ new ol.style.Style({
