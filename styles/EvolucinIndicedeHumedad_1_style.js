...
var style_EvolucinIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.427570 && value <= -0.339153) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.339153 && value <= -0.250735) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.250735 && value <= -0.162318) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.162318 && value <= -0.073901) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.073901 && value <= 0.014516) {
            style = [ new ol.style.Style({
